		...
		<div class="col-md-12 featured">
			<div id="wikisearch">
				...
				<form class="searchbox form-inline form-horizontal" action="http://de.wikipedia.org/wiki/Spezial:Suche" name="searchbox">
					...
					<input class="btn btn-default articleSearch" type="submit" value="Artikel-Suche" name="go"></input>
					<input class="btn btn-default fullSearch" type="submit" value="Volltextsuche" name="fulltext"></input>
				</form>
			</div>
			</br>
			<hr>
			...
			<p>
				...
				<a href="http://wave.webaim.org/report#/http://aperturelabs23.cloudcontrolled.com" title="WAVE Validierung">
